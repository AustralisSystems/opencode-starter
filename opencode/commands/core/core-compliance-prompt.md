...
- **MUST NOT:** Duplicate markdown documentation and markdown document documentation
- **MUST:** Create documentation ONLY in markdown documents
- **MAY:** Use markdown document functionality to convert documents to markdown IF required
