# === Universal Diataxis Documentation: AI-Driven Comprehensive Documentation Framework Protocol ===
...
- **MUST:** Output documentation in markdown documents only

**DIATAXIS DOCUMENTATION FOCUS AREAS:**
