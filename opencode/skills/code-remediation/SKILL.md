...
description: Fix code quality issues, security vulnerabilities, and standards violations based on analysis reports. Use when addressing linting errors, fixing security issues, or remediating quality problems.
allowed-tools: [*]
metadata:
...
# Code Remediation Orchestrator

**Type:** SDLC Code | **Fix & Remediate**

## Auto-Activation

I activate when you mention:
- "fix [quality/linting/security] issues"
- "remediate [code/vulnerabilities]"
- "address [violations/errors]"
...
**Examples:**
> "Fix issues in the authentication service with auto-approval"
> "Fix issues in the user management, auto-approve all gates" 
...
**Safety:** CAUTION: Fixes code issues. Review fixes before accepting
...
**READ**: `.mcp_prompts/sdlc/code/code-remediation-prompt.yaml`
...
`quality-validation`, `quality-security`, `python-refactor`
