...
This rule carries the full authoritative memory protocol from the repository-level `MEMORY.md`.

## When to apply

- Apply this rule whenever work requires memory recall, storage, relationships, compaction, pruning, or session-end summaries.
- Treat the repository-level `MEMORY.md` as the source of truth for detailed memory behavior.

## Authoritative source

- Source file: `MEMORY.md`
- Scope: recall, store, relationship governance, graph compaction, pruning, and session-end summarization.
